...
public class Prefabs {
    ...
    public static GameObject generateMario() {
        ...
        Spritesheet bigPlayerSprites = AssetPool.getSpritesheet("Assets/Sprites/bigSpritesheet.png");
        ...
        mario.getComponent(SpriteRenderer.class).setZIndex(10);

        return mario;
    }

    public static GameObject generateQuestionBlock() {
        Spritesheet playerSprites = AssetPool.getSpritesheet("Assets/Sprites/items.png");
    ...
    public static GameObject generateGoomba() {
        Spritesheet sprites = AssetPool.getSpritesheet("Assets/Sprites/spritesheet.png");
    ...
    public static GameObject generateTurtle() {
        Spritesheet turtleSprites = AssetPool.getSpritesheet("Assets/Sprites/turtle.png");
